...
$upgrade = false;
$dbHost = $dbUser = $dbPass = $dbName = $item_purchase_code = $readOnly = '';
...
if($upgrade)
    $finishLink = $installerLink.'upgrade.php';
else
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>AtoZ SEO Tools v3 | Installer panel</title>
    ...
    <link href="https://prothemes.biz/lic/api/tools/css.php?site=<?php echo $baseLink; ?>" rel="stylesheet" type="text/css" />
  ...
  <body class="skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo $_SERVER['PHP_SELF']; ?>" class="logo">
          ...
          <span class="logo-lg">AtoZ <b>SEO</b> Tools<sup>v3</sup></span>
        </a>
            ...
            <div id="index_0">  
              ...
              <div class="box box-primary">
               ...
               <div class="alert alert-warning">
                    <b>Note: </b>  Old v1 addons can't work on <b>AtoZ SEO Tools v2</b>. Need to re-download latest addon patches and install the addons again.
               </div>
               <?php } ?>
                ...
                <!-- form start -->
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input <?php echo $readOnly; ?> value="<?php echo $dbHost; ?>" type="text" placeholder="Enter your database hostname" name="data_host" id="data_host" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="data_name">Database Name</label>
                            <input <?php echo $readOnly; ?> value="<?php echo $dbName; ?>" type="text" placeholder="Enter your database name" name="data_name" id="data_name" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="data_user">Database Username</label>
                            <input <?php echo $readOnly; ?> value="<?php echo $dbUser; ?>" type="text" placeholder="Enter your database username" name="data_user" id="data_user" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="data_pass">Database Password</label>
                            <input <?php echo $readOnly; ?> value="<?php echo $dbPass; ?>" type="password" placeholder="Enter your database password" name="data_pass" id="data_pass" class="form-control">
                        </div>
                 ...
                 <div class="box-header"> <br />
                    <h3 class="box-title">License Verification</h3>
                        ...
                        <div class="form-group">
                            <label for="data_sec">Item Purchase Code &nbsp; <small><a target="_blank" href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-can-I-find-my-Purchase-Code-">(Where can I find my Purchase Code?)</a>  &nbsp; | &nbsp; <a target="_blank" href="http://api.prothemes.biz/tools/reset.php">(Reset Domain Name)</a></small></label>
                            <input value="<?php echo $item_purchase_code; ?>" style="border-color: #DDDDDD;" type="text" placeholder="Enter your item purchase code" name="data_sec" id="data_sec" class="form-control">
                        </div>
                    </div><!-- /.box-body -->
                   <div class="box-footer">    
                       <?php if(!$upgrade){ if(isset($fa)) { ?>
                          <button class="btn btn btn-primary" disabled >Submit</button>
                    <?php } else { ?>                                      
                          <button class="btn btn btn-primary" onclick="loadXMLDoc()" >Submit</button>
                     <?php } } else { ?>   
                          <button class="btn btn btn-primary" onclick="upgradeTov2()" >Upgrade</button>
                     <?php } ?>
                    </div>
    ...
    <br />  
     ...
     <!-- Main Footer -->
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="https://prothemes.biz/">ProThemes.Biz</a></strong> All rights reserved.
      </footer>
    ...
    function upgradeTov2(){
        ...
        var sql_sec = $('input[name=data_sec]').val();
        var data_domain = $('input[name=data_domain]').val();
        $.post("<?php echo $finishLink; ?>", {upgrade:1,data_host:sql_host,data_name:sql_name,data_user:sql_user,data_pass:sql_pass,data_sec:sql_sec,data_domain:data_domain}, function(results){
             $("#index_3").show();
