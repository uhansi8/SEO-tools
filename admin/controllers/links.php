...
$menuBarLinks['4'] = array(true, 'App Settings','#','fa fa-search', array(
                        array('sample','sample','fa fa-circle-o'),
                  ));
$menuBarLinks['4'] = array(true, 'SEO Tools','#','fa fa-cube', array(
                        array('Manage Tools','manage-tools','fa fa-circle-o'),
                        array('Additional Option','additional-option','fa fa-circle-o'),
                  )); 
...
$menuBarLinks['13'] = array(true, 'Addons','#','fa fa-plus-circle', array(
                        ...
                        array('','process-addon','fa fa-circle-o',false),
