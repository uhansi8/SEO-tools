...
$dbAdRow = mysqli_fetch_assoc($dbAd);
...
//Load User Settings
$query = mysqli_query($con,"SELECT enable_reg,enable_oauth,enable_quick,oauth_keys,visitors_limit,other_settings FROM user_settings WHERE id=1");
...
//OG Image
$ogImage = $baseURL.$themeOptions['general']['logo'];
